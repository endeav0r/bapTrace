...
const ::google::protobuf::Descriptor* operand_value_list_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  operand_value_list_reflection_ = NULL;
...
void protobuf_AssignDesc_frame_2epiqi_2eproto() {
  ...
  frame_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(frame));
  operand_value_list_descriptor_ = file->message_type(1);
  static const int operand_value_list_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(operand_value_list, elem_),
  };
  operand_value_list_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      operand_value_list_descriptor_,
      operand_value_list::default_instance_,
      operand_value_list_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(operand_value_list, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(operand_value_list, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(operand_value_list));
  ...
  static const int std_frame_offsets_[5] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(std_frame, operand_pre_list_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(std_frame, operand_post_list_),
  };
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    operand_value_list_descriptor_, &operand_value_list::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
...
void protobuf_ShutdownFile_frame_2epiqi_2eproto() {
  ...
  delete operand_value_list::default_instance_;
  delete operand_value_list_reflection_;
...
void protobuf_AddDesc_frame_2epiqi_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\030\006 \001(\0132\n.key_frame\"1\n\022operand_value_list"
    "\022\033\n\004elem\030\001 \003(\0132\r.operand_info\"\260\001\n\014operan"
    "d_info\0225\n\025operand_info_specific\030\001 \002(\0132\026."
    "operand_info_specific\022\022\n\nbit_length\030\002 \002("
    "\021\022%\n\roperand_usage\030\003 \002(\0132\016.operand_usage"
    "\022\037\n\ntaint_info\030\004 \002(\0132\013.taint_info\022\r\n\005val"
    "ue\030\005 \002(\014\"]\n\025operand_info_specific\022!\n\013mem"
    "_operand\030\001 \001(\0132\014.mem_operand\022!\n\013reg_oper"
    "and\030\002 \001(\0132\014.reg_operand\"\033\n\013reg_operand\022\014"
    "\n\004name\030\001 \002(\t\"\036\n\013mem_operand\022\017\n\007address\030\001"
    " \002(\004\"K\n\roperand_usage\022\014\n\004read\030\001 \002(\010\022\017\n\007w"
    "ritten\030\002 \002(\010\022\r\n\005index\030\003 \002(\010\022\014\n\004base\030\004 \002("
    "\010\"H\n\ntaint_info\022\020\n\010no_taint\030\001 \001(\010\022\020\n\010tai"
    "nt_id\030\002 \001(\004\022\026\n\016taint_multiple\030\003 \001(\010\"\240\001\n\t"
    "std_frame\022\017\n\007address\030\001 \002(\004\022\021\n\tthread_id\030"
    "\002 \002(\004\022\020\n\010rawbytes\030\003 \002(\014\022-\n\020operand_pre_l"
    "ist\030\004 \002(\0132\023.operand_value_list\022.\n\021operan"
    "d_post_list\030\005 \001(\0132\023.operand_value_list\"j"
    "\n\rsyscall_frame\022\017\n\007address\030\001 \002(\004\022\021\n\tthre"
    "ad_id\030\002 \002(\004\022\016\n\006number\030\003 \002(\004\022%\n\rargument_"
    "list\030\004 \002(\0132\016.argument_list\"\035\n\rargument_l"
    "ist\022\014\n\004elem\030\001 \003(\022\"b\n\017exception_frame\022\030\n\020"
    "exception_number\030\001 \002(\004\022\021\n\tthread_id\030\002 \001("
    "\004\022\021\n\tfrom_addr\030\003 \001(\004\022\017\n\007to_addr\030\004 \001(\004\"@\n"
    "\021taint_intro_frame\022+\n\020taint_intro_list\030\001"
    " \002(\0132\021.taint_intro_list\".\n\020taint_intro_l"
    "ist\022\032\n\004elem\030\001 \003(\0132\014.taint_intro\"a\n\013taint"
    "_intro\022\014\n\004addr\030\001 \002(\004\022\020\n\010taint_id\030\002 \002(\004\022\r"
    "\n\005value\030\003 \001(\014\022\023\n\013source_name\030\004 \001(\t\022\016\n\006of"
    "fset\030\005 \001(\004\"O\n\rmodload_frame\022\023\n\013module_na"
    "me\030\001 \002(\t\022\023\n\013low_address\030\002 \002(\004\022\024\n\014high_ad"
    "dress\030\003 \002(\004\"<\n\tkey_frame\022/\n\022tagged_value"
    "_lists\030\001 \002(\0132\023.tagged_value_lists\"6\n\022tag"
    "ged_value_lists\022 \n\004elem\030\001 \003(\0132\022.tagged_v"
    "alue_list\"a\n\021tagged_value_list\022+\n\020value_"
    "source_tag\030\001 \002(\0132\021.value_source_tag\022\037\n\nv"
    "alue_list\030\002 \002(\0132\013.value_list\";\n\020value_so"
    "urce_tag\022\024\n\014no_thread_id\030\001 \001(\010\022\021\n\tthread"
    "_id\030\002 \001(\004\"\'\n\nvalue_list\022\031\n\004elem\030\001 \003(\0132\013."
    "value_info\"\207\001\n\nvalue_info\0225\n\025operand_inf"
    "o_specific\030\001 \002(\0132\026.operand_info_specific"
    "\022\022\n\nbit_length\030\002 \002(\021\022\037\n\ntaint_info\030\003 \001(\013"
    "2\013.taint_info\022\r\n\005value\030\004 \002(\014", 1948);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "frame.piqi.proto", &protobuf_RegisterTypes);
  frame::default_instance_ = new frame();
  operand_value_list::default_instance_ = new operand_value_list();
  ...
  operand_value_list::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int operand_value_list::kElemFieldNumber;
#endif  // !_MSC_VER

operand_value_list::operand_value_list()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void operand_value_list::InitAsDefaultInstance() {
}

operand_value_list::operand_value_list(const operand_value_list& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void operand_value_list::SharedCtor() {
  _cached_size_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void operand_value_list::SharedDtor() {
  if (this != default_instance_) {
  }
}

void operand_value_list::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* operand_value_list::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return operand_value_list_descriptor_;
}

const operand_value_list& operand_value_list::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_frame_2epiqi_2eproto();  return *default_instance_;
}

operand_value_list* operand_value_list::default_instance_ = NULL;

operand_value_list* operand_value_list::New() const {
  return new operand_value_list;
}

void operand_value_list::Clear() {
  elem_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  mutable_unknown_fields()->Clear();
}

bool operand_value_list::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void operand_value_list::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // repeated .operand_info elem = 1;
...
::google::protobuf::uint8* operand_value_list::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // repeated .operand_info elem = 1;
  for (int i = 0; i < this->elem_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
...
int operand_value_list::ByteSize() const {
  int total_size = 0;
...
void operand_value_list::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const operand_value_list* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const operand_value_list*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void operand_value_list::MergeFrom(const operand_value_list& from) {
  GOOGLE_CHECK_NE(&from, this);
  elem_.MergeFrom(from.elem_);
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}

void operand_value_list::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void operand_value_list::CopyFrom(const operand_value_list& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool operand_value_list::IsInitialized() const {
...
void operand_value_list::Swap(operand_value_list* other) {
  if (other != this) {
...
::google::protobuf::Metadata operand_value_list::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = operand_value_list_descriptor_;
  metadata.reflection = operand_value_list_reflection_;
  return metadata;
}
...
const int std_frame::kOperandPreListFieldNumber;
const int std_frame::kOperandPostListFieldNumber;
#endif  // !_MSC_VER
...
void std_frame::InitAsDefaultInstance() {
  operand_pre_list_ = const_cast< ::operand_value_list*>(&::operand_value_list::default_instance());
  operand_post_list_ = const_cast< ::operand_value_list*>(&::operand_value_list::default_instance());
}
...
void std_frame::SharedCtor() {
  ...
  operand_pre_list_ = NULL;
  operand_post_list_ = NULL;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
void std_frame::SharedDtor() {
  ...
  if (this != default_instance_) {
    delete operand_pre_list_;
    delete operand_post_list_;
  }
}
...
void std_frame::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (has_operand_pre_list()) {
      if (operand_pre_list_ != NULL) operand_pre_list_->::operand_value_list::Clear();
    }
    if (has_operand_post_list()) {
      if (operand_post_list_ != NULL) operand_post_list_->::operand_value_list::Clear();
    }
  }
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
  mutable_unknown_fields()->Clear();
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 3: {
        ...
        if (input->ExpectTag(34)) goto parse_operand_pre_list;
        break;
      }
      ...
      case 4: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_operand_pre_list:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_operand_pre_list()));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectTag(42)) goto parse_operand_post_list;
        break;
      }
      ...
      case 5: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_operand_post_list:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_operand_post_list()));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectAtEnd()) return true;
...
void std_frame::SerializeWithCachedSizes(
  ...
  if (has_operand_pre_list()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      4, this->operand_pre_list(), output);
  }
  
  // optional .operand_value_list operand_post_list = 5;
  if (has_operand_post_list()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      5, this->operand_post_list(), output);
  }
...
::google::protobuf::uint8* std_frame::SerializeWithCachedSizesToArray(
  ...
  if (has_operand_pre_list()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        4, this->operand_pre_list(), target);
  }
  ...
  if (has_operand_post_list()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        5, this->operand_post_list(), target);
  }
...
void std_frame::MergeFrom(const std_frame& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_operand_pre_list()) {
      mutable_operand_pre_list()->::operand_value_list::MergeFrom(from.operand_pre_list());
    }
    if (from.has_operand_post_list()) {
      mutable_operand_post_list()->::operand_value_list::MergeFrom(from.operand_post_list());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
bool std_frame::IsInitialized() const {
  ...
  if (has_operand_pre_list()) {
    if (!this->operand_pre_list().IsInitialized()) return false;
  }
  if (has_operand_post_list()) {
    if (!this->operand_post_list().IsInitialized()) return false;
  }
  return true;
}
...
void std_frame::Swap(std_frame* other) {
  if (other != this) {
    ...
    std::swap(operand_pre_list_, other->operand_pre_list_);
    std::swap(operand_post_list_, other->operand_post_list_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
