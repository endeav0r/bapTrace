...
class operand_value_list : public ::google::protobuf::Message {
 public:
  operand_value_list();
  virtual ~operand_value_list();
  
  operand_value_list(const operand_value_list& from);
  
  inline operand_value_list& operator=(const operand_value_list& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const operand_value_list& default_instance();
  
  void Swap(operand_value_list* other);
  
  // implements Message ----------------------------------------------
  
  operand_value_list* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const operand_value_list& from);
  void MergeFrom(const operand_value_list& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static operand_value_list* default_instance_;
};
// -------------------------------------------------------------------
...
class std_frame : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_operand_pre_list() const;
  inline void clear_operand_pre_list();
  static const int kOperandPreListFieldNumber = 4;
  inline const ::operand_value_list& operand_pre_list() const;
  inline ::operand_value_list* mutable_operand_pre_list();
  inline ::operand_value_list* release_operand_pre_list();
  
  // optional .operand_value_list operand_post_list = 5;
  inline bool has_operand_post_list() const;
  inline void clear_operand_post_list();
  static const int kOperandPostListFieldNumber = 5;
  inline const ::operand_value_list& operand_post_list() const;
  inline ::operand_value_list* mutable_operand_post_list();
  inline ::operand_value_list* release_operand_post_list();
 ...
 private:
  ...
  inline void set_has_operand_pre_list();
  inline void clear_has_operand_pre_list();
  inline void set_has_operand_post_list();
  inline void clear_has_operand_post_list();
  ...
  ::operand_value_list* operand_pre_list_;
  ::operand_value_list* operand_post_list_;
...
// repeated .operand_info elem = 1;
inline int operand_value_list::elem_size() const {
  return elem_.size();
}
inline void operand_value_list::clear_elem() {
  elem_.Clear();
}
inline const ::operand_info& operand_value_list::elem(int index) const {
  return elem_.Get(index);
}
inline ::operand_info* operand_value_list::mutable_elem(int index) {
  return elem_.Mutable(index);
}
inline ::operand_info* operand_value_list::add_elem() {
  return elem_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::operand_info >&
operand_value_list::elem() const {
  return elem_;
}
inline ::google::protobuf::RepeatedPtrField< ::operand_info >*
operand_value_list::mutable_elem() {
  return &elem_;
}
...
// required .operand_value_list operand_pre_list = 4;
inline bool std_frame::has_operand_pre_list() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void std_frame::set_has_operand_pre_list() {
  _has_bits_[0] |= 0x00000008u;
}
inline void std_frame::clear_has_operand_pre_list() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void std_frame::clear_operand_pre_list() {
  if (operand_pre_list_ != NULL) operand_pre_list_->::operand_value_list::Clear();
  clear_has_operand_pre_list();
}
inline const ::operand_value_list& std_frame::operand_pre_list() const {
  return operand_pre_list_ != NULL ? *operand_pre_list_ : *default_instance_->operand_pre_list_;
}
inline ::operand_value_list* std_frame::mutable_operand_pre_list() {
  set_has_operand_pre_list();
  if (operand_pre_list_ == NULL) operand_pre_list_ = new ::operand_value_list;
  return operand_pre_list_;
}
inline ::operand_value_list* std_frame::release_operand_pre_list() {
  clear_has_operand_pre_list();
  ::operand_value_list* temp = operand_pre_list_;
  operand_pre_list_ = NULL;
  return temp;
}

// optional .operand_value_list operand_post_list = 5;
inline bool std_frame::has_operand_post_list() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void std_frame::set_has_operand_post_list() {
  _has_bits_[0] |= 0x00000010u;
}
inline void std_frame::clear_has_operand_post_list() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void std_frame::clear_operand_post_list() {
  if (operand_post_list_ != NULL) operand_post_list_->::operand_value_list::Clear();
  clear_has_operand_post_list();
}
inline const ::operand_value_list& std_frame::operand_post_list() const {
  return operand_post_list_ != NULL ? *operand_post_list_ : *default_instance_->operand_post_list_;
}
inline ::operand_value_list* std_frame::mutable_operand_post_list() {
  set_has_operand_post_list();
  if (operand_post_list_ == NULL) operand_post_list_ = new ::operand_value_list;
  return operand_post_list_;
}
inline ::operand_value_list* std_frame::release_operand_post_list() {
  clear_has_operand_post_list();
  ::operand_value_list* temp = operand_post_list_;
